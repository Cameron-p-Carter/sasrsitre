...
export default function Footer() {
  return (
    <footer className="bg-[#0c2080] px-16 py-20">
      <div className="max-w-[1280px] mx-auto">
        {/* Main Footer Content */}
        <div className="flex gap-16 items-start mb-44">
          {/* Logo Column */}
          ...
          <div className="flex gap-16">
            {/* First Awards Column */}
            <div className="flex flex-col gap-4 w-[104px]">
          ...
          <div className="flex gap-16">
            ...
            <div className="flex flex-col gap-4 w-[160px]">
              <h3 className="text-white text-[16px] font-semibold leading-[1.5] mb-2">
                Company Info
              </h3>
              <div className="flex flex-col">
                <a href="#" className="text-white text-[14px] font-normal leading-[1.5] py-2 hover:text-[#5ae0f6] transition-colors">
                  Home
                </a>
                <a href="#" className="text-white text-[14px] font-normal leading-[1.5] py-2 hover:text-[#5ae0f6] transition-colors">
                  Services
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            {/* Copyright and Links */}
            <div className="flex items-center gap-6 text-white text-[14px] font-normal leading-[1.5]">
              <span>© 2025 Software@Scale. All rights reserved.</span>
              <a href="#" className="underline hover:text-[#5ae0f6] transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="underline hover:text-[#5ae0f6] transition-colors">
                Terms of Service
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-6 h-6 text-white hover:text-[#5ae0f6] transition-colors">
