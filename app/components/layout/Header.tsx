              ...
              <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible z-50">
                <div className="bg-[#0c2080] border border-[#14d3f3] rounded-2xl p-6 min-w-[260px]">
                  <div className="flex flex-col gap-4">
                    ...
                    <Link href="/services/data-ai" className="font-semibold text-[#14d3f3] text-base leading-6 hover:opacity-80 transition-opacity whitespace-nowrap">
                      Data & AI
                    </Link>
                  </div>
                </div>
                ...
                {expandedMobileSection === 'services' && (
                  <div className="pb-4 pl-4">
                    <div className="flex flex-col gap-4">
                      ...
                      <Link href="/services/data-ai" className="font-semibold text-[#14d3f3] text-base leading-6 py-1">
                        Data & AI
                      </Link>
                    </div>
                  </div>
