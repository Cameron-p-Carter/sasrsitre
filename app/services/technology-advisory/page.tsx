...
Our approach involves a comprehensive assessment of your current setup, deep performance analysis, and implementation of best practices to ensure your cloud platform is not just functional but exceptional.`,
  ...
  imageTextListContent: {
    title: "Fast, focused expertise, exactly when it's needed",
    introDescription: "Access to experienced technology leaders and specialist engineers can make all the difference during critical moments. Whether it's shaping a clear technology strategy or stepping in to deliver high-impact projects, our flexible, fractional approach ensures the right skills are applied at the right time, without the overhead of full-time commitments.",
    listTitle: "How Technology Advisory and Fractional Resources work:",
    listItems: [
      "Discovery & needs assessment",
      "Strategy and roadmap development",
      "Fractional leadership & expert placement",
      "Pilot and trial execution",
